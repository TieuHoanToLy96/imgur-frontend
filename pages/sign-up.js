      ...
      <div className="sign-container">
        ...
        <div className="sign-form core-dark-bg">
          <div className="sign-form--content">
            ...
            <Input className="mb-10" placeholder="Email"/>
            <Input className="mb-10" placeholder="Password"/>
            <Input className="mb-10" placeholder="Retype Password"/>
          </div>
        </div>
        <div className="is-flex is-flex--vcenter is-flex--end mt-5">
          ...
          <Button className="button-register" type="primary" size="large" onClick={handleClickRegister}>Register</Button>
        </div>
      </div>
    </div>
  )
